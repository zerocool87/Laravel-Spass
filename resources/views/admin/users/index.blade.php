<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-4">
                <a href="{{ route('admin.users.create') }}" class="px-4 py-2 neon-btn">Create User</a>
            </div>
                ...
                <table class="w-full text-gray-100 divide-y divide-gray-700 cyber-table">
                    ...
                    <tbody class="bg-transparent">
                        ...
                        <tr class="odd:bg-transparent even:bg-gray-800/20">
                            ...
                            <td class="py-3 px-4">
                                <a href="{{ route('admin.users.edit', $user) }}" class="inline-flex items-center px-2 py-1 bg-gradient-to-r from-indigo-600 to-cyan-500 hover:from-indigo-500 hover:to-cyan-400 text-white rounded text-sm">Edit</a>
                                <form action="{{ route('admin.users.destroy', $user) }}" method="POST" style="display:inline-block" onsubmit="return confirm('Delete user?');">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="inline-flex items-center px-2 py-1 bg-gradient-to-r from-red-600 to-rose-500 hover:from-red-500 hover:to-rose-400 text-white rounded text-sm ms-2">Delete</button>
                                </form>
                            </td>
                        </tr>
                        @endforeach
