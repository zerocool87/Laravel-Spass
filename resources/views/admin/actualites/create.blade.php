<x-app-layout>
    <x-slot name="header">
        <x-elus-header
            title="{{ __('Nouvelle actualité') }}"
            subtitle="{{ __('Rédiger et publier une actualité') }}"
            icon="📰"
    ...
    <x-slot name="breadcrumbs">
        <x-breadcrumbs :items="[['label' => __('Accueil'), 'url' => route('elus.dashboard')], ['label' => __('Administration'), 'url' => route('elus.admin.index')], ['label' => __('Actualités'), 'url' => route('admin.actualites.index')], ['label' => __('Nouvelle')]]" />
    </x-slot>
