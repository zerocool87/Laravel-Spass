                                ...
                                <div class="grid grid-cols-2 gap-4 mt-4">
                                    ...
                                    <div>
                                        ...
                                        <select name="timezone" id="timezone"
                                            ...
                                            <option value="Europe/Paris" {{ old('timezone', $reunion->timezone) == 'Europe/Paris' ? 'selected' : '' }}>
                                                {{ __('Europe/Paris') }}
                                            </option>
                                            <option value="UTC" {{ old('timezone', $reunion->timezone) == 'UTC' ? 'selected' : '' }}>
                                                {{ __('UTC') }}
                                            </option>
                                            <option value="America/New_York" {{ old('timezone', $reunion->timezone) == 'America/New_York' ? 'selected' : '' }}>
                                                {{ __('America/New_York') }}
                                            </option>
                                        </select>
                                        @error('timezone')
