    ...
    <div class="py-8">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl shadow-lg border border-[#faa21b]/20 p-8">
                ...
                <form id="edit-form" method="POST" action="{{ route('admin.instances.update', $instance) }}" class="space-y-6">
                    @csrf
                    @method('PUT')
                            ...
                            <div>
                                ...
                                <select name="territory" id="territory"
                                    ...
                                    @foreach($communes as $commune)
                                        <option value="{{ $commune }}" {{ old('territory', $instance->territory) === $commune ? 'selected' : '' }}>
                                            {{ $commune }}
                                        </option>
                                    @endforeach
                                </select>
