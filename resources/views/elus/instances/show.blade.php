    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
                <a href="{{ route('elus.instances.index') }}" class="text-gray-500 hover:text-gray-700">
                ...
                <div>
                    ...
                    <h2 class="font-semibold text-xl leading-tight">{{ $instance->name }}</h2>
                </div>
            </div>
            <div class="flex space-x-2">
                ...
                <a href="{{ route('elus.instances.edit', $instance) }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-50 transition">
                    {{ __('Modifier') }}
                </a>
                @endcan
            </div>
