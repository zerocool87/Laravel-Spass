<x-app-layout>
    ...
    <x-slot name="breadcrumbs">
        <x-breadcrumbs :items="[['label' => __('Accueil'), 'url' => route('elus.dashboard')], ['label' => __('Administration'), 'url' => route('elus.admin.index')], ['label' => __('Utilisateurs')]]" />
    </x-slot>
            ...
            @if(session('resetLink'))
                <div class="bg-gradient-to-r from-yellow-50 to-amber-50 border-2 border-yellow-400 text-yellow-900 px-6 py-4 rounded-xl shadow-lg">
                    <div class="flex items-start">
                        ...
                        <div class="flex-1">
                            <p class="mb-3">L'élu a été créé. Pour définir son mot de passe, utilisez la page de réinitialisation :</p>
                            <a href="{{ session('resetLink') }}" class="text-blue-600 underline font-semibold hover:text-blue-800">
                                {{ session('resetLink') }}
                            </a>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-lg border border-[#faa21b]/20">
                <div class="flex flex-col gap-4 px-6 pt-6 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <button type="button" @click="showModal = true" class="inline-flex items-center justify-center px-5 py-2.5 bg-[#faa21b] text-white rounded-xl font-semibold text-sm shadow-lg hover:shadow-xl transition">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {{-- Create Élu Modal --}}
    <div x-data="{ showModal: false }" x-show="showModal" x-cloak class="fixed inset-0 z-50 overflow-y-auto" style="display: none;">
