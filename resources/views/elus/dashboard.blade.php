        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-xl shadow-lg border-2 border-[#faa21b]/15 flex flex-col overflow-hidden hover:shadow-xl transition-shadow">
                <div class="px-4 py-3 bg-[#faa21b]/10 border-b-[1.5px] border-[#faa21b]/20 flex items-center justify-between gap-2">
                    <h3 class="text-sm font-bold text-[#faa21b] flex items-center gap-2">
                        ...
                        {{ __('Prochaines réunions') }}
                    </h3>
                    <a href="{{ route('elus.reunions.calendar') }}" class="text-xs font-semibold text-[#faa21b] hover:text-[#e89315] flex items-center gap-1 transition">
                        {{ __('Calendrier') }}
                ...
                <div class="divide-y divide-orange-50 overflow-y-auto flex-1">
                    ...
                    @empty
                        <div class="flex flex-col items-center justify-center text-gray-400 py-10">
                            ...
                            <p class="text-sm font-medium">{{ __('Aucune réunion à venir') }}</p>
                        </div>
                    @endforelse
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg border-2 border-[#faa21b]/15 flex flex-col overflow-hidden hover:shadow-xl transition-shadow">
                <div class="px-4 py-3 bg-[#faa21b]/10 border-b-[1.5px] border-[#faa21b]/20 flex items-center justify-between gap-2">
                    ...
                    <a href="{{ route('elus.actualites.index') }}" class="text-xs font-semibold text-[#faa21b] hover:text-[#e89315] flex items-center gap-1 transition">
                        {{ __('Tout voir') }}
                        <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                    </a>
                </div>
                <div class="divide-y divide-orange-50 overflow-y-auto flex-1">
                    ...
                    @empty
                        <div class="flex flex-col items-center justify-center text-gray-400 py-10">
                            ...
                            <p class="text-sm font-medium">{{ __('Aucune actualité') }}</p>
                        </div>
                    @endforelse
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg border-2 border-[#faa21b]/15 flex flex-col overflow-hidden hover:shadow-xl transition-shadow">
                <div class="px-4 py-3 bg-[#faa21b]/10 border-b-[1.5px] border-[#faa21b]/20 flex items-center justify-between gap-2">
                    ...
                    <a href="{{ route('elus.instances.index') }}" class="text-xs font-semibold text-[#faa21b] hover:text-[#e89315] flex items-center gap-1 transition">
                        {{ __('Tout voir') }}
                        <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                    </a>
                </div>
                <div class="divide-y divide-orange-50 overflow-y-auto flex-1">
                    ...
                    @empty
                        <div class="flex flex-col items-center justify-center text-gray-400 py-10">
                            ...
                            <p class="text-sm font-medium">{{ __('Aucune instance') }}</p>
                        </div>
                    @endforelse
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg border-2 border-[#faa21b]/15 flex flex-col overflow-hidden hover:shadow-xl transition-shadow">
                <div class="px-4 py-3 bg-[#faa21b]/10 border-b-[1.5px] border-[#faa21b]/20 flex items-center justify-between gap-2">
                    ...
                    <a href="{{ route('elus.documents.index') }}" class="text-xs font-semibold text-[#faa21b] hover:text-[#e89315] flex items-center gap-1 transition">
                        {{ __('Bibliothèque') }}
                        <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                    </a>
                </div>
                <div class="divide-y divide-orange-50 overflow-y-auto flex-1">
                    ...
                    @empty
                        <div class="flex flex-col items-center justify-center text-gray-400 py-10">
                            ...
                            <p class="text-sm font-medium">{{ __('Aucun document récent') }}</p>
                        </div>
                    @endforelse
                </div>
            </div>
