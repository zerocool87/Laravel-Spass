<x-app-layout>
    <x-slot name="header">
        <x-elus-header
            title="{{ __('Nouveau projet') }}"
            subtitle="{{ __('Créer un nouveau projet territorial') }}"
            icon="➕"
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <form method="POST" action="{{ route('elus.projects.store') }}">
                    ...
                    <div class="space-y-6">
                        ...
                        <div x-data="{ territories: @js(old('territories', [])), newTerritory: '', addTerritory() { let v = this.newTerritory.trim(); if (v && !this.territories.includes(v)) { this.territories.push(v); this.newTerritory = ''; } } }">
