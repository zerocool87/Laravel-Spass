        ...
        <div class="bg-[#faa21b] -mx-8 -my-6 px-8 py-6 shadow-lg">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h2 class="font-bold text-2xl text-white mb-1">➕ {{ __('Nouveau projet') }}</h2>
                        <p class="text-white/90 text-sm">{{ __('Créer un nouveau projet territorial') }}</p>
                    </div>
                </div>
                <nav class="flex space-x-2 items-center">
                    ...
                    <a href="{{ route('elus.projects.index') }}" class="px-4 py-2 text-sm bg-white text-[#FFA500] hover:bg-white/90 rounded-lg transition font-bold">{{ __('Projets') }}</a>
    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-lg shadow p-6">
                <form method="POST" action="{{ route('elus.projects.store') }}">
                    @csrf
