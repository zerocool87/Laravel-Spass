        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="glass p-6 rounded-xl shadow-md">
                ...
                <div class="flex flex-wrap items-center gap-4 text-gray-700 mb-4">
                    ...
                    <span class="inline-flex items-center px-3 py-1 rounded-full bg-[#faa21b]/15 text-[#b36b00] text-sm font-medium">
                        <svg class="w-4 h-4 mr-1 text-[#faa21b]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 12.414a4 4 0 10-1.414 1.414l4.243 4.243a1 1 0 001.414-1.414z"/></svg>
                        {{ $event->location }}
                    </span>
                    @if($event->type)
                        <span class="inline-flex items-center px-3 py-1 rounded-full bg-[#faa21b]/15 text-[#b36b00] text-sm font-medium">
                            <svg class="w-4 h-4 mr-1 text-[#faa21b]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 1.343-3 3s1.343 3 3 3 3-1.343 3-3-1.343-3-3-3zm0 10c-4.418 0-8-1.79-8-4V6a2 2 0 012-2h12a2 2 0 012 2v8c0 2.21-3.582 4-8 4z"/></svg>
                            {{ $event->type }}
                        </span>
                    @endif
                </div>
